...
rm(wghts, esd_class, warn_df, inv_carto, f, p, inv_plots)
```
...
rm(r_locations_ne, r_locations, noxious_presence_analysis, noxious_cover_analysis)
```


\begin{wrapfigure}{r}{0.5\textwidth}
  \centering
    \includegraphics[width=0.5\textwidth]{../results/maps/allFO_weeds.png}
  \caption{Distribution of Invasive Species Across the Field Office}
\end{wrapfigure}
